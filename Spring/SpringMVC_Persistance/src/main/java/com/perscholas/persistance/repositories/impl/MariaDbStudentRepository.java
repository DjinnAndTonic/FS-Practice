package com.perscholas.persistance.repositories.impl;
...
public class MariaDbStudentRepository implements StudentRepository {
	...
	public Student getStudentById(Integer id) {
		String selectStudentsById = "select * from students where id = :id";
	...
	public Boolean updateStudent(Student student) {
		...
		String updateSql = "update students set name = :name, email = :email where id = :id";
