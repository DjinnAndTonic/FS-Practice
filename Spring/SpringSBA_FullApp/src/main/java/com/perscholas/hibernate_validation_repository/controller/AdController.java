...
public class AdController {
	...
	public String validateLogin(@Valid @ModelAttribute("user2") User user,
			BindingResult result, Model model) {
	...
	@PostMapping("/addAd")
	public String addAd(@Valid @ModelAttribute("ad") Ad ad, 
			BindingResult result, Model model) 
	...
	public String removeAd(@PathVariable Integer adId) 
